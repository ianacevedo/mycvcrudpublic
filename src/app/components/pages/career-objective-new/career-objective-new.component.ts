...
@Component({
  selector: 'app-career-objective-new',
  templateUrl: './career-objective-new.component.html',
  styleUrls: ['./career-objective-new.component.css']
})
export class CareerObjectiveNewComponent implements OnInit, OnChanges {
  @Input()
